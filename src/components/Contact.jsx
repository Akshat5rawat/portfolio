    ...
    const contactInfo = [
        {
            icon: '📧',
            title: 'Email',
            value: 'akshat5rawat@gmail.com',
            link: 'mailto:akshat5rawat@gmail.com',
        },
        {
            icon: '📱',
            title: 'Phone',
            value: '+91 89547 42723',
            link: 'tel:+918954742723',
        },
        {
            icon: '📍',
            title: 'Location',
                    ...
                    <div className="contact-info">
                        ...
                        <div className="contact-cards">
                            {contactInfo.map((info, index) => (
                                <a key={index} href={info.link} className="contact-card card">
                        ...
                        <div className="social-links">
                            <a href="https://github.com/Akshat5rawat" target="_blank" rel="noopener noreferrer" className="social-btn">
                            ...
                            <a href="https://linkedin.com/in/akshat5rawat/" target="_blank" rel="noopener noreferrer" className="social-btn">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
